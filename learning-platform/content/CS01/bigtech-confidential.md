...
description: >-
  Internal BigTech memo outlining the strategic rationale for licensing Core IP
  to NewCo and concerns about the founders' inexperience.
learning_objectives:
  - >-
    Understand the strategic reasons an incumbent company would license IP to a
    spin-off.
