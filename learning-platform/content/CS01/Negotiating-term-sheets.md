...
description: >-
  A guide to negotiating term sheets, focusing on the key concepts of economics
  and control, and understanding leverage.
learning_objectives:
  - >-
    Understand the two primary components of any term sheet: economics and
    control.
  - >-
    Identify sources of leverage in a negotiation, such as competition and
    traction.
...
keywords:
  ...
  - >-
    rights of first refusal: get first right to participate in the next round on
    same terms as the round
