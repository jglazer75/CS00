...
description: >-
  An overview of essential financial documents for startups, including pro forma
  statements, projected financials, and competitive analysis.
learning_objectives:
  - Explain the purpose and use of pro forma financial statements
  - >-
    Produce and Analyze projected financials for a 6 month, 1 year, and 3 year
    time horizon.
  - >-
    Explain the benefits and general processes for performing a robust market
    competition analysis
  - >-
    Explain the purpose of a pitch deck and its synthesis of business models,
