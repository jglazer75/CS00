...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: montserrat.style.fontFamily, fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '0.1em', fontSize: '2rem' },
    h2: { fontFamily: montserrat.style.fontFamily, fontWeight: 700, fontSize: '1.5rem' },
    h3: { fontFamily: montserrat.style.fontFamily, fontWeight: 600, textTransform: 'uppercase' as const, fontSize: '1.25rem' },
    h4: { fontFamily: montserrat.style.fontFamily, fontWeight: 600, fontSize: '1.1rem' },
    h5: { fontFamily: montserrat.style.fontFamily, fontWeight: 600, fontSize: '1rem' },
